...
import cool.rdf.ret.cli.AbstractCommand;
import cool.rdf.ret.cli.LoggingMixin;
import cool.rdf.ret.cli.Ret;
import cool.rdf.ret.cli.RetDiagram;
import cool.rdf.ret.cli.RetInfer;
import cool.rdf.ret.cli.RetWrite;
...
public class RetFeature implements Feature {
    @Override
    public void beforeAnalysis( final BeforeAnalysisAccess access ) {
        ...
        Native.forClass( Ret.class ).registerClass().registerAllFields().registerAllMethods();
        Native.forClass( RetDiagram.class ).registerClass().registerAllFields().registerAllMethods();
        Native.forClass( RetWrite.class ).registerClass().registerAllFields().registerAllMethods();
        Native.forClass( RetInfer.class ).registerClass().registerAllFields().registerAllMethods();
